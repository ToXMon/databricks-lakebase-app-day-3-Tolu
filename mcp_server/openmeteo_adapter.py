...
# flat import) and "from mcp_server.openmeteo_adapter import ..." (run from
# day3/ as a namespace package, e.g. in tests/smoke checks).
try:
    from weather_codes import describe as describe_weather_code
except ImportError:
    from mcp_server.weather_codes import describe as describe_weather_code
